...
<!--                    <td width="18%" align="center" bgcolor="#EEEEEE"> <a href="#" class="right-font08" onclick="selectAll();">Select All</a>&nbsp;&nbsp;&nbsp;<a href="#" class="right-font08" onclick="unselectAll();">UnSelect All</a></span></td>-->
                    ...
                    <td width="15%" align="center" bgcolor="#EEEEEE">Sku</td>
...
<!--                    <td width="10%" align="center" bgcolor="#EEEEEE">ShoprID</td>-->
                    ...
                    <td width="14%" align="center" bgcolor="#EEEEEE">Operations</td>
                  </tr>
...
<!--                    <td bgcolor="#FFFFFF"><input type="checkbox" name="id"/></td>-->
                    ...
                    <td bgcolor="#FFFFFF"><%=p.getCategory() %></td>
                     ...
                     <td bgcolor="#FFFFFF"><a href="updateProduct.do?id=<%=p.getId() %>">Update</a> <a href="deleteProduct.do?ids=<%=p.getId() %>">Delete</a></td>
                  </tr>
