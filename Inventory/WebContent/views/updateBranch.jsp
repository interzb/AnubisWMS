...
<%
	...
	Branch p = (Branch)request.getAttribute("Branch");
%>
...
<body class="ContentBody">
	<form action="<%=context %>/updateBranchDo.do" method="post"  name="fom"
		id="fom" target="mainFrame">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">Update Branch</th>
				</tr>
				<tr>
					<td class="CPanel">
									...
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												...
												<td><input name="address" id="" class="text"  value=<%=p.getAddress()%>
