...
<body class="ContentBody">
	<form action="<%=context %>/addFamily.do" method="post"  name="fom"
		id="fom" target="mainFrame">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">Add Family</th>
				</tr>
				<tr>
					<td class="CPanel">
								...
								<TD width="100%">
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												<td nowrap align="right">Family Description:</td>
												<td><input name="desc" id="" class="text"
