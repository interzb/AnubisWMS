...
-->
	...
	<%
		PageView pageView = (PageView) request.getAttribute("Branchs");
	%>

	<body class="ContentBody">
		<form action="<%=context%>/updateBranchDo.do" method="post"
															...
															<td height="40" class="font42">
																<table width="100%" border="0" cellpadding="4"
																	...
																	<tr align="center">
																		...
																		<td bgcolor="#FFFFFF"><%=p.getAddress()%></td>
																		<td bgcolor="#FFFFFF">
																			<a href="updateBranch.do?id=<%=p.getId()%>">Update</a>
																			<a href="deleteBranch.do?ids=<%=p.getId()%>">Delete</a>
																		</td>
																	</tr>
													...
													<table width="100%" border="0" align="center"
														...
														<tr>
															<td width="99%">
																...
																<a href="branchList.do?currentPage=<%=i%>"
