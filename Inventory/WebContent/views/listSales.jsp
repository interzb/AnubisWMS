...
<%@page import="com.inventory.model.SalesEntry"%>
...
-->
	...
	<%
		PageView pageView = (PageView) request.getAttribute("salesEntries");
	%>

	<body class="ContentBody">
		<form action="<%=context%>/listSales.do" method="post" name="fom"
										...
										<table width="99%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Branch: 
													...
													Group By Product:
													<input type=checkbox name=groupByProduct >
