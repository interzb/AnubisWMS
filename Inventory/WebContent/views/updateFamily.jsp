...
<%
	...
	Family p = (Family)request.getAttribute("Family");
%>
	...
	<form action="<%=context %>/updateFamilyDo.do" method="post"  name="fom"
		...
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">Update Family</th>
				</tr>
				<tr>
					<td class="CPanel">
								...
								<TD width="100%">
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												<td nowrap align="right" width="13%">Family Name:</td>
												<td width="41%"><input name="name" class="text" value=<%=p.getName() %>
													style="width: 150px" type="text" size="40" /> <span
													class="red"> *<%=RequestUtil.geteMessage(request, "Name_Error") %></span>
											...
											<tr>
												<td nowrap align="right">Family Address:</td>
												<td><input name="desc" id="" class="text"  value=<%=p.getDesc()%>
													style="width: 254px" /> <span class="red">*<%=RequestUtil.geteMessage(request, "Desc_Error") %></span></td>
											</tr>
